...
namespace System.Management.Automation.Internal
{
    ...
    internal class Pipe
    {
        ...
        internal void Add(object obj)
        {
            ...
            {
                if (obj != null && obj.GetType().ToString() == "System.Management.Automation.PSObject")
                {
                    PSObject temp = (PSObject)obj;
                    if (temp.ImmediateBaseObject.GetType().ToString() == "System.Management.Automation.ErrorRecord")
                    {
                        Console.WriteLine(((ErrorRecord)temp.ImmediateBaseObject).Exception.Message);
                        return;
                    }
                }
            }
