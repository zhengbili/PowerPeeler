...
#pragma warning disable CS1591 
        public void InvokeDeobfuscation(int time)
#pragma warning restore CS1591 
        {
            //Deobfuscation
            DeobfuscationGlobalVariables.scriptBlock = this.Commands.Commands[0].CommandText;
            DeobfuscationUtils.scriptBlockInstruction = this.Commands.Commands[0].CommandText;
            DeobfuscationGlobalVariables.EnableDeobfuscation = true;
            DeobfuscationGlobalVariables.isTimeOut = true;
            DeobfuscationUtils.log.Clear();
            DeobfuscationUtils.instructions = 0;

            if (Environment.GetEnvironmentVariable("sandboxNativeBlacklist") != null)
            {
                DeobfuscationGlobalVariables.nativeBlacklist = Environment.GetEnvironmentVariable("sandboxNativeBlacklist").Split(' ');
            }
            if (Environment.GetEnvironmentVariable("sandboxCmdletBlacklist") != null)
            {
                DeobfuscationGlobalVariables.cmdletBlacklist = Environment.GetEnvironmentVariable("sandboxCmdletBlacklist").Split(' ');
            }
            if (Environment.GetEnvironmentVariable("sandboxDotnetBlacklist") != null)
            {
                DeobfuscationGlobalVariables.dotnetBlacklist = Environment.GetEnvironmentVariable("sandboxDotnetBlacklist").Split(' ');
            }
            if (Environment.GetEnvironmentVariable("sandboxIexObfuscations") != null)
            {
                DeobfuscationGlobalVariables.iexObfuscations = Environment.GetEnvironmentVariable("sandboxIexObfuscations").Split(' ');
            }

            DeobfuscationGlobalVariables.loopVariables.Push(new Stack());

            /*new System.Threading.Tasks.TaskFactory().StartNew(() => {
                Invoke(null, null);
            }).Wait(time * 1000);*/
            Thread t = new Thread(new ThreadStart(() => {
                try { InvokeDeobfuscationTimeLimit(); } catch (ThreadInterruptedException) { }
            }));
            t.Start();
            t.Join(time * 1000);
            t.Interrupt();
...
#pragma warning disable CS1591 
        public Collection<PSObject> InvokeDeobfuscationTimeLimit()
#pragma warning restore CS1591 
        {
            Collection<PSObject> result = Invoke(null, null);
            DeobfuscationGlobalVariables.isTimeOut = false;
            return result;
        }

#pragma warning disable CS1591 
        public void InvokeRecord(int time)
#pragma warning restore CS1591 
        {
            DeobfuscationGlobalVariables.EnableRecord = true;
            DeobfuscationUtils.sinkFunctionRecord.Clear();
            DeobfuscationGlobalVariables.EnableInstructionsRecord = true;
            DeobfuscationUtils.instructions = 0;
            InvokeDeobfuscation(time);
        }
...
#pragma warning restore CS1591 
        {
            return DeobfuscationGlobalVariables.isTimeOut;
        }

#pragma warning disable CS1591 
        public void Amsi(int time, string inputPath, string resultPath)
        {
            DeobfuscationUtils.enableAmsi = true;
            DeobfuscationUtils.amsiInputPath = inputPath;
            DeobfuscationUtils.amsiResultPath = resultPath;
            /*new System.Threading.Tasks.TaskFactory().StartNew(() => {
                Invoke(null, null);
            }).Wait(time * 1000);*/
            Thread t = new Thread(new ThreadStart(() => {
...
#pragma warning disable CS1591 
        public void EndAmsi()
        {
            DeobfuscationUtils.enableAmsi = false;
            DeobfuscationUtils.amsiInputPath = string.Empty;
            DeobfuscationUtils.amsiResultPath = string.Empty;
        }

#pragma warning disable CS1591 
        public void Detect(int time, string inputPath, string resultPath)
        {
            DeobfuscationUtils.enableAmsi = true;
            DeobfuscationUtils.amsiInputPath = inputPath;
            DeobfuscationUtils.amsiResultPath = resultPath;
            DeobfuscationUtils.amsiLogs.Clear();
            InvokeDeobfuscation(time);
        }
...
#pragma warning disable CS1591 
        ...
        public void EndDeobfuscation()
#pragma warning restore CS1591 
        {
            DeobfuscationGlobalVariables.EnableDeobfuscation = false;

            DeobfuscationGlobalVariables.currentExpr = null;
            DeobfuscationGlobalVariables.whileAst.Clear();
            DeobfuscationGlobalVariables.currentInstruction = null;
            DeobfuscationGlobalVariables.astMap.Clear();
            DeobfuscationGlobalVariables.scriptBlock = string.Empty;
            DeobfuscationUtils.scriptBlockInstruction = string.Empty;
            DeobfuscationGlobalVariables.blocks.Clear();
            //DeobfuscationGlobalVariables.loops.Clear();
            //DeobfuscationGlobalVariables.ifs.Clear();
            DeobfuscationGlobalVariables.currentInstruction = null;
            DeobfuscationGlobalVariables.endLoopMap.Clear();
            DeobfuscationGlobalVariables.setMembers.Clear();
            DeobfuscationGlobalVariables.loopVariables.Clear();
            DeobfuscationGlobalVariables.dotNetInfo.Clear();

            Environment.SetEnvironmentVariable("sandboxNativeBlacklist", null);
            Environment.SetEnvironmentVariable("sandboxCmdletBlacklist", null);
            Environment.SetEnvironmentVariable("sandboxDotnetBlacklist", null);
            Environment.SetEnvironmentVariable("sandboxIexObfuscations", null);
...
#pragma warning restore CS1591 
        {
            DeobfuscationGlobalVariables.EnableRecord = false;
            DeobfuscationGlobalVariables.EnableInstructionsRecord = false;
            EndDeobfuscation();
        }

#pragma warning disable CS1591 
        public List<Dictionary<string, object>> ObtainLogs()
#pragma warning restore CS1591 
        {
            return DeobfuscationUtils.log;
        }

#pragma warning disable CS1591 
        public List<Dictionary<string, object>> ObtainRecords()
#pragma warning restore CS1591 
        {
            return DeobfuscationUtils.sinkFunctionRecord;
        }

#pragma warning disable CS1591 
        public int ObtainInstructions()
#pragma warning restore CS1591 
        {
            return DeobfuscationUtils.instructions;
        }
        /// <summary>
